...
def render_exam_progress(logo_tag):
    ...
    .exam-clock-wrap {{ display:flex; flex-direction:row; align-items:baseline; gap:10px; }}
    .exam-clock-label {{ font-size:0.75rem; font-weight:800; color:#333; letter-spacing:0.5px; }}
