...
EXAM_FILES = {
    ...
    "חשבונאות פיננסית מתקדמת": ["advanced_financial_01.json"],
}

# זמן בחינה לפי נושא — נושא שלא מופיע כאן = דיפולט 120 דקות
# 40 שאלות תמיד (ברזל)
# זמן מחושב: זמן_מקורי/שאלות_מקוריות × 40, מעוגל למעלה לכפולה של 5
# מימון: 180/34×40 = 211.76 → 215 דקות
# חשבונאות פיננסית מתקדמת: בחינה פתוחה 4 שעות → 200 דקות (הערכה לפי מורכבות שאלות)
EXAM_OVERRIDES = {
